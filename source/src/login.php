...
<head>
    ...
    <style type="text/css">
        html { }
        body { color:#fff; font-size:13px; padding:0; overflow:hidden; margin:0; width:100%; height:100%; min-height:400px; background-image:url(static/images/login/backg.jpg); background-repeat: no-repeat; background-position: 20%; background-size: 100% 155%}

        h1 { font-wieght:bold; font-size:22px; padding:0 30px; margin:0; text-shadow:0 1px 3px rgba(0, 0, 0, 0.4); }
        #login_form { position:absolute; width:500px; }


        .input { font-family: Georgia, serif;margin-left:5px;font-size: 22px; padding-left: 12px; padding-right: 0px; width: 234px; height:30px; background:url(static/imges/login/spacer.gif); color:#383838; outline:medium none; border:none; }
        ...
        .submit_bg { background:url(static/images/login/submit.png); width:80px; height:42px; position:absolute; overflow:hidden; margin-top:34px; }
  ...
  <table border="0" align="center" height="100%" width="500">
    ...
    <tr>
      <td height="200" align="center">
        <div style="text-align:left;width:700px;height:100px;margin-left:-100px;background:url(static/images/login/admin-name.png) no-repeat left top;_background:none;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='static/image/login/admin-name.png');">
          <div style="position:absolute;margin:-220px 0 0 831px;">
            <table border="0" cellpadding="0" cellspacing="0" width="30" height="10">
              <tr>
                <td align="left" valign="bottom"><img id="image1" style="width:260px;height:260px;" src="static/images/login/sun.png" /></td>
              </tr>
            </table>
          </div>
          <div style="position:absolute;margin:-10px 0 0 532px;">
            <table style="width:60px;height:50px;" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="bottom"><img id="image2" style="width:190px;height:180px;" src="static/images/login/cloud-.png" /></td>
              </tr>
            </table>
          </div>
